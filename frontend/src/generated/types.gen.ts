...
export type UploadDocumentData = {
    body: {
        /**
         * Source file. Accepted extensions: png, jpg, jpeg, txt, md,
         ...
         */
        series?: string;
        [key: string]: Blob | File | string | Array<string> | undefined;
    };
    path?: never;
    query?: never;
    url: '/api/v1/documents';
...
export type UploadDocumentErrors = {
    ...
    409: ErrorResponse;
    /**
     * Validation failure (invalid multipart form, malformed
     * `artifact:*:*` field name, unknown stage or field, or seed
     * artifact exceeds the 1 MiB cap).
     *
     */
    422: ErrorResponse;
};
