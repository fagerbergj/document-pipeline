...
func (m *mockLLM) ChatWithTools(ctx context.Context, model_ string, messages []port.LLMMessage, tools []port.LLMTool) (port.LLMChatResponse, error) {
	return port.LLMChatResponse{Text: m.textResponse}, m.err
}
